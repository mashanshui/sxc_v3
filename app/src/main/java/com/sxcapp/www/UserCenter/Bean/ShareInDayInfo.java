...
public class ShareInDayInfo implements Parcelable {
    ...
    protected ShareInDayInfo(Parcel in) {
        pageCount = in.readInt();
        pageIndex = in.readInt();
        pageSize = in.readInt();
    }

    public static final Creator<ShareInDayInfo> CREATOR = new Creator<ShareInDayInfo>() {
        @Override
        public ShareInDayInfo createFromParcel(Parcel in) {
            return new ShareInDayInfo(in);
        }

        @Override
        public ShareInDayInfo[] newArray(int size) {
            return new ShareInDayInfo[size];
        }
    };
    ...
    public static class DataBean implements Parcelable {
        ...
        public static class OrderInfoBean implements Parcelable {
            ...
            public void writeToParcel(Parcel dest, int flags) {
                ...
                dest.writeDouble(no_deductible);

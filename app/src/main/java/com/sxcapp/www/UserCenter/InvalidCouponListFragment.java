...
import com.sxcapp.www.UserCenter.Adapter.InvalidCouponListAdapterV3;
...
public class InvalidCouponListFragment extends Fragment {
    private View contentView;
    private List<CouponBeanV3> list;
    private ListView lv;
    private ImageView empty_iv;

    public static InvalidCouponListFragment NewInstance(ArrayList<CouponBeanV3> couponBeanV3List) {
        InvalidCouponListFragment usefulCouponListFragment = new InvalidCouponListFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (list.size() > 0) {
            InvalidCouponListAdapterV3 adapterV3 = new InvalidCouponListAdapterV3(this.getContext(), list);

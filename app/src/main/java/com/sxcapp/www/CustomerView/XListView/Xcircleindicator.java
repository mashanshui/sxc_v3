package com.sxcapp.www.CustomerView.XListView;
...
public class Xcircleindicator extends View {
    ...
    public Xcircleindicator(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            int fillColor = a.getColor(R.styleable.XCircleIndicator_fillColor, 0x259b24);
            int strokeColor = a.getColor(
                    R.styleable.XCircleIndicator_strokeColor, 0xcc1a20);
            // Retrieve the radius
    ...
    public void initColors(int fillColor, int strokeColor) {
    ...
    public void initColor(int fillColor, int strokeColor) {
        mPaintStroke.setStyle(Paint.Style.STROKE);
        mPaintStroke.setColor(strokeColor);
        mPaintFill.setStyle(Paint.Style.FILL);
        mPaintFill.setColor(fillColor);

...
public class InDayTypeAdapter extends BaseAdapter {
    private Context context;
    private List<CarTypeBean> list;
    private int selectedPosition = -1;

    public InDayTypeAdapter(Context context, List<CarTypeBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.city_tv.setText(list.get(position).getType());

...
import com.sxcapp.www.Share.Adapter.ElecInDayCarAdapterV3;
...
public class ElecInDayRentActivityV3 extends BaseActivity implements View.OnClickListener, MapLoiIml {
    ...
    private ElecInDayCarAdapterV3 adapterV3;
    private List<ElecShareInDayRentCarListBeanV3.CarListBean> carListBeanList;
    private List<List<String>> ll;
    private List<List<ElecShareInDayRentCarListBeanV3.CarListBean.LongSettingListBean>> long_setting_array;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elec_inday_rent_v3);
    ...
    private void loadData() {
        ...
        showProgressDlg();
        Observable<CodeResultV3<ElecShareInDayRentCarListBeanV3>> ob = service.getElecInDayCarListV3(fetch_store_id, g_store_id, user_id);
        ob.compose(compose(this.<CodeResultV3<ElecShareInDayRentCarListBeanV3>>bindToLifecycle())).subscribe(new CodeObserverV3<ElecShareInDayRentCarListBeanV3>(this) {
            @Override
            protected void onHandleSuccess(final ElecShareInDayRentCarListBeanV3 beanV3) {
                removeProgressDlg();
                carListBeanList = beanV3.getCar_list();
                adapterV3 = new ElecInDayCarAdapterV3(ElecInDayRentActivityV3.this, carListBeanList);
                ...
                if (carListBeanList.size() > 0) {
                    ...
                    for (int i = 0; i < long_setting_array.size(); i++) {
                        ...
                        for (int index = 0; index < long_setting_array.get(i).size(); index++) {
                            ElecShareInDayRentCarListBeanV3.CarListBean.LongSettingListBean bean = long_setting_array.get(i).get(index);
                    ...
                    ruleAdapter = new RuleAdapter(ElecInDayRentActivityV3.this, ll);
                ...
                rent_day_type_re.setOnClickListener(ElecInDayRentActivityV3.this);
                no_deductible_re.setOnClickListener(ElecInDayRentActivityV3.this);
                appoint_btn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (TextUtils.isEmpty(rent_day_type_id)) {
                            ...
                            showGreenAlertDlg("确定付费租车", R.string.ok, new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                ...
                coupon_re.setOnClickListener(ElecInDayRentActivityV3.this);
                ...
                fetch_store_re.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(ElecInDayRentActivityV3.this, StoreDetailActivityV3.class);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.no_deductible_re:
                ...
                break;
            case R.id.coupon_re:
                Intent intent = new Intent(ElecInDayRentActivityV3.this, OrderCouponListActivityV3.class);
                intent.putExtra("order_no", order_no);
                intent.putExtra("setting_id", rent_day_type_id);
                intent.putExtra("from", "elec_inday");
    ...
    private void doCheckUser() {
        showProgressDlg();
        Observable<CodeResultV3<Object>> ob = service.commonDoCheckUser(user_id, 2, rent_day_type_id, no_deductible, car_id, 0 + "");
        ob.compose(compose(this.<CodeResultV3<Object>>bindToLifecycle())).subscribe(new CodeObserverV3<Object>(this) {
            ...
            protected void onHandleSuccess(Object object) {
                if (AndroidTool.isGetLocationPermission(ElecInDayRentActivityV3.this)) {
                    if (lat != 0) {
                        showProgressDlg();
                        appoint_btn.setClickable(false);
                        appointCar();
            ...
            protected void onHandleError(String msg, CodeResultV3<Object> value) {
                ...
                if ("712".equals(value.getCode()) || "714".equals(value.getCode()) || "718".equals(value.getCode()) ||
                    ...
                    try {
                        ...
                        Intent intent = new Intent(ElecInDayRentActivityV3.this, RepairActivityV3.class);
    ...
    private void doRp() {
        ...
        ob.compose(compose(this.<CodeResultV3<RPTokenV3>>bindToLifecycle())).subscribe(new CodeObserverV3<RPTokenV3>(this) {
            ...
            protected void onHandleSuccess(RPTokenV3 rpTokenV3) {
                removeProgressDlg();
                RPSDK.start(rpTokenV3.getToken(), ElecInDayRentActivityV3.this,
    ...
    private void appointCar() {
        Observable<CodeResultV3<ElecInDayAppointReturnBeanV3>> ob = service.elecInDayRentCarV3(user_id, fetch_store_id, g_store_id, car_id, no_deductible, rent_day_type_id, coupon_id, lat + "", lng + "");
        ob.compose(compose(this.<CodeResultV3<ElecInDayAppointReturnBeanV3>>bindToLifecycle())).subscribe(new CodeObserverV3<ElecInDayAppointReturnBeanV3>(this) {
            @Override
            protected void onHandleSuccess(ElecInDayAppointReturnBeanV3 o) {
                removeProgressDlg();
                showToast("租车成功");
            ...
            @Override
            protected void onHandleError(String msg, CodeResultV3<ElecInDayAppointReturnBeanV3> value) {
                super.onHandleError(msg, value);
                appoint_btn.setClickable(true);
                rent_day_type_re.setClickable(true);
                no_deductible_re.setClickable(true);
    ...
    private void unLockCar() {
        ...
        ob.compose(compose(this.<CodeResultV3<UnLockCarIsPhoto>>bindToLifecycle())).subscribe(new CodeObserverV3<UnLockCarIsPhoto>(this) {
            ...
            protected void onHandleSuccess(UnLockCarIsPhoto isPhoto) {
                appoint_btn.setClickable(true);
                removeProgressDlg();
                Intent intent = new Intent(ElecInDayRentActivityV3.this, ElecInDayEndActivityV3.class);
                intent.putExtra("order_no", order_no);
            ...
            protected void onHandleError(String msg, CodeResultV3<UnLockCarIsPhoto> value) {
                ...
                if ("994".equals(value.getCode())) {
                    if (value.getObj().getImage_flag() == 0) {
                        Intent intent = new Intent(ElecInDayRentActivityV3.this, UploadCarInfoActivityV3.class);
                        intent.putExtra("order_no", order_no);
    ...
    private void getUseCouponSize() {
        showProgressDlg();
        Observable<CodeResultV3<OrderCouponSizeBeanV3>> ob = service.getElecIndayOrderCouponSizeV3(user_id, rent_day_type_id);

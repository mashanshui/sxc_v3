...
public class UploadIDCardActivityV3 extends BaseActivity {
    @BindView(R.id.iv)
    ImageView iv;
    ...
    private String image_str, image_str_key, user_id, order_no;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_idcard_v3);
        ButterKnife.bind(this);
        setTopbarLeftWhiteBackBtn();
        setTopBarColor(R.color.luxury);
        setStatusView(R.color.luxury);
        setTopBarTitle("豪车身份证审核", null);
    ...
    private void uploadCreditCard() {
        ...
        map.put("type", "3");
        map.put("id_card_image", image_str);
        map.put("id_card_image_view", image_str_key);
        Observable<CodeResultV3<Object>> ob = service.uploadLuxuyInfoV3(map);
    ...
    public void uploadImage(final String url) {
        ...
        Observable<CodeResultV3<ImageBeanV3>> observable = uploadService.uploadImageV3("idCardImage", requestFile);
        observable.compose(compose(this.<CodeResultV3<ImageBeanV3>>bindToLifecycle())).subscribe(new CodeObserverV3<ImageBeanV3>(this) {
            ...
            protected void onHandleSuccess(ImageBeanV3 imageBeanV3) {
                ...
                Glide.with(UploadIDCardActivityV3.this).load(url).into(iv);
    ...
    public void getPermission() {
        if (Build.VERSION.SDK_INT >= 23) {
            PermissionGen.with(UploadIDCardActivityV3.this)
                    .addRequestCode(100)
                    .permissions(
    ...
    public void deleteImage() {
        ...
        ContentResolver mContentResolver = UploadIDCardActivityV3.this.getContentResolver();
...
//发送广播
        ...
        intent.setData(uri);
        UploadIDCardActivityV3.this.sendBroadcast(intent);
    }

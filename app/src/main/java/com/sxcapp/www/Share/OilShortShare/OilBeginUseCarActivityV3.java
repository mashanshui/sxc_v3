...
public class OilBeginUseCarActivityV3 extends BaseActivity implements View.OnClickListener, MapLoiIml {
...
//    order_state(0待取车 1待还车 6待支付)
    private int what_use, order_state;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oil_short_begin_usecar);
        ...
        int width = AndroidTool.getDeviceWidth(OilBeginUseCarActivityV3.this) - AndroidTool.dip2px(OilBeginUseCarActivityV3.this, 74);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(width, width / 2);
        layoutParams.addRule(RelativeLayout.CENTER_HORIZONTAL);
        layoutParams.setMargins(0, AndroidTool.dip2px(OilBeginUseCarActivityV3.this, 27), 0, 0);
    ...
    private void loadData() {
        showProgressDlg();
        Observable<CodeResultV3<OilShortBeginUseCarBeanV3>> ob = service.getOilBeginUserInfoV3(order_no);
        ob.compose(compose(this.<CodeResultV3<OilShortBeginUseCarBeanV3>>bindToLifecycle())).subscribe(new CodeObserverV3<OilShortBeginUseCarBeanV3>(this) {
            @Override
            protected void onHandleSuccess(final OilShortBeginUseCarBeanV3 beanV3) {
                removeProgressDlg();
                Glide.with(OilBeginUseCarActivityV3.this).load(beanV3.getCar_image()).into(car_iv);
                ...
                cancel_order_lin.setOnClickListener(OilBeginUseCarActivityV3.this);
                blow_lin.setOnClickListener(OilBeginUseCarActivityV3.this);
                begin_lin.setOnClickListener(OilBeginUseCarActivityV3.this);
                change_g_lo_tv.setOnClickListener(OilBeginUseCarActivityV3.this);
                ...
                if (order_state == 0) {
                    ...
                    unlock_car_lin.setOnClickListener(OilBeginUseCarActivityV3.this);
                    short_lock_lin.setOnClickListener(OilBeginUseCarActivityV3.this);
                    end_appoint_btn.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {

                            if (AndroidTool.isGetLocationPermission(OilBeginUseCarActivityV3.this)) {
                                if (lat != 0) {
                                    showProgressDlg();
                ...
                fetch_store_re.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(OilBeginUseCarActivityV3.this, StoreDetailActivityV3.class);
    ...
    private void cancelOrder() {
        ...
        Observable<CodeResultV3<Object>> ob = service.oilShortCancelOrderV3(order_no);
    ...
    private void unLockCar() {
        Observable<CodeResultV3<UnLockCarIsPhoto>> ob = service.getOilCarUnLockV3(order_no, lat + "", lng + "");
            ...
            protected void onHandleError(String msg, CodeResultV3<UnLockCarIsPhoto> value) {
                ...
                if ("994".equals(value.getCode())) {
                    if (value.getObj().getImage_flag() == 0) {
                        Intent intent = new Intent(OilBeginUseCarActivityV3.this, UploadCarInfoActivityV3.class);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.change_g_lo_tv:
                Intent intent = new Intent(OilBeginUseCarActivityV3.this, SelectGStoreActivityV3.class);
                ...
                intent.putExtra("from", "oil_short_order");
                intent.putExtra("order_no", order_no);
                intent.putExtra("order_type", 3);
    ...
    private void getShareCarCost() {
        Observable<CodeResultV3<OilShortPreCostBeanV3>> ob = service.getOilShorePreCostV3(order_no);
        ob.compose(compose(this.<CodeResultV3<OilShortPreCostBeanV3>>bindToLifecycle())).subscribe(new CodeObserverV3<OilShortPreCostBeanV3>(this) {
            @Override
            protected void onHandleSuccess(OilShortPreCostBeanV3 costBeanV3) {
            ...
            @Override
            protected void onHandleError(String msg, CodeResultV3<OilShortPreCostBeanV3> value) {
                super.onHandleError(msg, value);
                mHandler.sendEmptyMessageDelayed(COST_STATISTIC, 2 * 60 * 1000);
            }
        });
...
//image_flag=0，中控，用后4张都未传   image_flag=2，中控未传    image_flag=3，用后3张未传  image_flag=1，已传

    private void endUse() {
        Observable<CodeResultV3<UnLockCarIsPhoto>> ob = service.oilShortEndUseV3(order_no, lat + "", lng + "");
        ob.compose(compose(this.<CodeResultV3<UnLockCarIsPhoto>>bindToLifecycle())).subscribe(new CodeObserverV3<UnLockCarIsPhoto>(this) {
            @Override
            protected void onHandleSuccess(UnLockCarIsPhoto isPhoto) {
                removeProgressDlg();
                ...
                Intent intent = new Intent(OilBeginUseCarActivityV3.this, OilPayActivityV3.class);
                intent.putExtra("order_no", order_no);
                startActivity(intent);
            }
            ...
            protected void onHandleError(String msg, CodeResultV3<UnLockCarIsPhoto> value) {
                ...
                if ("993".equals(value.getCode()) || "992".equals(value.getCode())) {
                    if (value.getObj().getImage_flag() == 0) {
                        Intent intent = new Intent(OilBeginUseCarActivityV3.this, UploadOilMassImageActivityV3.class);
                        intent.putExtra("order_no", order_no);
                        intent.putExtra("car_id", car_id);
                        intent.putExtra("order_type", 3);

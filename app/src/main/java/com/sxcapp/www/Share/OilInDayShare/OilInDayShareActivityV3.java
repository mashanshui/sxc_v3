...
public class OilInDayShareActivityV3 extends BaseActivity implements MapLoiIml,
    ...
    private void mapDot() {
        ...
        Observable<CodeResultV3<ElectricMapStoreListBeanV3>> ob = service.getOilInDayMapStoreListV3();
...
//                            mAMap.moveCamera(CameraUpdateFactory.newLatLngZoom(latLngmarker, 11));
                                ...
                                public View getInfoWindow(final Marker marker) {
                                    ...
                                    navigation_iv.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            if (isGet) {
                                                Intent intent = new Intent(OilInDayShareActivityV3.this, NaviMainActivity.class);
    ...
    public void getPermission() {
        ...
        if (Build.VERSION.SDK_INT >= 23 && !sdCardWritePermission) {
            PermissionGen.with(OilInDayShareActivityV3.this)
                    .addRequestCode(100)
                    .permissions(
...
//       将属性设置给窗体
    ...
    private void showSelectStoreDialog(final String storeName) {
        ...
        select_g_store_re.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(OilInDayShareActivityV3.this, SelectGStoreActivityV3.class);
                ...
                intent.putExtra("from", "oil_inday_map");
        ...
        fetch_store_detail_re.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(OilInDayShareActivityV3.this, StoreDetailActivityV3.class);
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(g_store_name)) {
                    ...
                    if (SharedData.getInstance().isLogin()) {
                        dialog.dismiss();
                        Intent intent = new Intent(OilInDayShareActivityV3.this, OilInDayRentActivityV3.class);
                        ...
                        startActivityForResult(new Intent(OilInDayShareActivityV3.this, LoginActivity.class), LOGIN_REQUEST);
                    }
                }
            }
        });
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.problem_feedback_re:
                if (SharedData.getInstance().isLogin()) {
                    Intent intent1 = new Intent(OilInDayShareActivityV3.this, ProblemFeedbackActivity.class);
                    intent1.putExtra("from", "oil");
                    startActivity(intent1);
                } else {
                    Intent intent_register = new Intent(OilInDayShareActivityV3.this, LoginActivity.class);

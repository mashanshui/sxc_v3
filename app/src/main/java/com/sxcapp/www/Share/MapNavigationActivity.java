 ...
 * 按照选定策略导航
 */
public class MapNavigationActivity extends BaseActivity implements AMapNaviViewListener ,AMapNaviListener,AMap.OnMapLoadedListener{
    ...
    private void getNaviParam() {
        ...
        NaviLatLng start = new NaviLatLng(lat, lng);
//算路起点坐标
        NaviLatLng end = getIntent().getParcelableExtra("end");

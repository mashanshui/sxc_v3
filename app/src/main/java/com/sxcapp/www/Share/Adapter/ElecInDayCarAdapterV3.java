...
public class ElecInDayCarAdapterV3 extends PagerAdapter {
    private Context context;
    private List<ElecShareInDayRentCarListBeanV3.CarListBean> list;

    public ElecInDayCarAdapterV3(Context context, List<ElecShareInDayRentCarListBeanV3.CarListBean> list) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ElecShareInDayRentCarListBeanV3.CarListBean bean = list.get(position);

...
import com.sxcapp.www.Share.ElectricShortShare.ShortShareAppointActivityV3;
...
public class ElectricShareActivityV3 extends BaseActivity implements MapLoiIml,
    ...
    private void mapDot() {
        ...
        Observable<CodeResultV3<ElectricMapStoreListBeanV3>> ob = service.getElecMapStoreListV3();
                                ...
                                public View getInfoWindow(final Marker marker) {
                                    ...
                                    navigation_iv.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            if (isGet) {
                                                Intent intent = new Intent(ElectricShareActivityV3.this, NaviMainActivity.class);
//                                                intent.putExtra("start", new NaviLatLng(lat, lon));
    ...
    public void getPermission() {
        ...
        if (Build.VERSION.SDK_INT >= 23 && !sdCardWritePermission) {
            PermissionGen.with(ElectricShareActivityV3.this)
                    .addRequestCode(100)
                    .permissions(
...
//       将属性设置给窗体
    ...
    private void showSelectStoreDialog(final String storeName) {
        ...
        select_g_store_re.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ElectricShareActivityV3.this, SelectGStoreActivityV3.class);
                ...
                intent.putExtra("from", "elec_short_map");
        ...
        fetch_store_detail_re.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ElectricShareActivityV3.this, StoreDetailActivityV3.class);
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(g_store_name)) {
                    ...
                    if (SharedData.getInstance().isLogin()) {
                        dialog.dismiss();
                        Intent intent = new Intent(ElectricShareActivityV3.this, ShortShareAppointActivityV3.class);
                        ...
                        startActivityForResult(new Intent(ElectricShareActivityV3.this, LoginActivity.class), LOGIN_REQUEST);
                    }
                }
            }
        });
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.problem_feedback_re:
                if (SharedData.getInstance().isLogin()) {
                    Intent intent1 = new Intent(ElectricShareActivityV3.this, ProblemFeedbackActivity.class);
                    intent1.putExtra("from", "elec");
                    startActivity(intent1);
                } else {
                    Intent intent_register = new Intent(ElectricShareActivityV3.this, LoginActivity.class);

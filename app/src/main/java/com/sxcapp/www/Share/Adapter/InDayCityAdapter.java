...
public class InDayCityAdapter extends BaseAdapter {
    private Context context;
    private List<InDayCityBean> list;
    private int selectedPosition = -1;

    public InDayCityAdapter(Context context, List<InDayCityBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.city_tv.setText(list.get(position).getCityname());

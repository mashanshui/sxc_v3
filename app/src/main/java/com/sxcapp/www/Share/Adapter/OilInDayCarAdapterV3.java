...
public class OilInDayCarAdapterV3 extends PagerAdapter {
    private Context context;
    private List<OilShareInDayRentCarListBeanV3.CarListBean> list;

    public OilInDayCarAdapterV3(Context context, List<OilShareInDayRentCarListBeanV3.CarListBean> list) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        OilShareInDayRentCarListBeanV3.CarListBean bean = list.get(position);

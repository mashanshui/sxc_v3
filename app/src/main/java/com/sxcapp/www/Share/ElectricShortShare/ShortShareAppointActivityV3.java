...
import com.sxcapp.www.Share.Adapter.ElecShortCarAdapterV3;
...
import com.sxcapp.www.Share.OilShortShare.OilShareAppointActivityV3;
...
public class ShortShareAppointActivityV3 extends BaseActivity implements View.OnClickListener {
    ...
    private List<ElecShortCarInfoBeanV3> carInfoBeanV3List;
    private ElecShortCarAdapterV3 adapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elec_short_appoint_v3);
    ...
    private void loadData() {
        ...
        Observable<CodeResultV3<ElecShortAppointBeanV3>> ob = service.getCarList_elec_shortV3(fetch_store_id, g_store_id);
        ob.compose(compose(this.<CodeResultV3<ElecShortAppointBeanV3>>bindToLifecycle())).subscribe(new CodeObserverV3<ElecShortAppointBeanV3>(this) {
            @Override
            protected void onHandleSuccess(final ElecShortAppointBeanV3 elecShortAppointBeanV3) {
                removeProgressDlg();
                carInfoBeanV3List = elecShortAppointBeanV3.getList();
                adapter = new ElecShortCarAdapterV3(ShortShareAppointActivityV3.this, carInfoBeanV3List);
                ...
                if (elecShortAppointBeanV3.getList().size() > 0) {
                    for (int i = 0; i < elecShortAppointBeanV3.getList().size(); i++) {
                        ll.add(elecShortAppointBeanV3.getList().get(i).getSettings());
                    }
                    ruleAdapter = new RuleAdapter(ShortShareAppointActivityV3.this, ll);
                ...
                no_deductible_re.setOnClickListener(ShortShareAppointActivityV3.this);
                appoint_btn.setOnClickListener(ShortShareAppointActivityV3.this);
                fetch_store_re.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(ShortShareAppointActivityV3.this, StoreDetailActivityV3.class);
                        intent.putExtra("from", "elec");
                        intent.putExtra("store_id", elecShortAppointBeanV3.getFetch_store_id());
                ...
                select_g_store_re.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(ShortShareAppointActivityV3.this, StoreDetailActivityV3.class);
                        intent.putExtra("from", "elec");
                        intent.putExtra("store_id", elecShortAppointBeanV3.getReturn_store_id());
                        startActivity(intent);
                    }
                });
    ...
    private void appointCar() {
        Observable<CodeResultV3<ElecShortAppointReturnBeanV3>> ob = service.elecShort_appointV3(user_id, fetch_store_id, g_store_id, car_id, no_deductible);
        ob.compose(compose(this.<CodeResultV3<ElecShortAppointReturnBeanV3>>bindToLifecycle())).subscribe(new CodeObserverV3<ElecShortAppointReturnBeanV3>(this) {
            @Override
            protected void onHandleSuccess(ElecShortAppointReturnBeanV3 elecShortAppointReturnBeanV3) {
                removeProgressDlg();
                appoint_btn.setClickable(true);
                Intent intent = new Intent(ShortShareAppointActivityV3.this, BeginUseCarActivityV3.class);
                intent.putExtra("order_no", elecShortAppointReturnBeanV3.getOrder_no());
                intent.putExtra("order_state", "0");
                startActivity(intent);
            }

            @Override
            protected void onHandleError(String msg, CodeResultV3<ElecShortAppointReturnBeanV3> value) {
    ...
    private void doCheckUser() {
        showProgressDlg();
        Observable<CodeResultV3<Object>> ob = service.commonDoCheckUser(user_id, 1, 0 + "", no_deductible, car_id, 0 + "");
            ...
            protected void onHandleError(String msg, CodeResultV3<Object> value) {
                ...
                if ("712".equals(value.getCode()) || "714".equals(value.getCode()) || "718".equals(value.getCode()) ||
                    ...
                    try {
                        ...
                        Intent intent = new Intent(ShortShareAppointActivityV3.this, RepairActivityV3.class);
    ...
    private void doRp() {
        ...
        ob.compose(compose(this.<CodeResultV3<RPTokenV3>>bindToLifecycle())).subscribe(new CodeObserverV3<RPTokenV3>(this) {
            ...
            protected void onHandleSuccess(RPTokenV3 rpTokenV3) {
                removeProgressDlg();
                RPSDK.start(rpTokenV3.getToken(), ShortShareAppointActivityV3.this,

...
public class OilShortShareActivityV3 extends BaseActivity implements MapLoiIml,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setTopBarTitle("共享燃油分时", null);
        setStatusView(R.color.top_bar_red);
        setTopBarColor(R.color.top_bar_red);
        StatusBarUtil.StatusBarDarkMode(this);
        setTopbarLeftWhiteBackBtn();
        zoom_out_iv.setBackgroundResource(R.mipmap.map_zoom_out_gray_v3);
        zoom_in_iv.setBackgroundResource(R.mipmap.map_zoom_in_gray_v3);
        lopoi_iv.setBackgroundResource(R.mipmap.lopoi_pic_gray_v3);
        service_iv.setBackgroundResource(R.mipmap.gray_service_center_v3);
    ...
    private void mapDot() {
        ...
        Observable<CodeResultV3<OilMapStoreListBeanV3>> ob = service.getOilShortMapStoreListV3();
        ob.compose(compose(this.<CodeResultV3<OilMapStoreListBeanV3>>bindToLifecycle())).subscribe(new CodeObserverV3<OilMapStoreListBeanV3>(this) {
            @Override
            protected void onHandleSuccess(OilMapStoreListBeanV3 listBeanV3) {
                removeProgressDlg();
                for (OilMapStoreListBeanV3.ListBeanXX listBeanXX : listBeanV3.getList()) {
                    ...
                    for (OilMapStoreListBeanV3.ListBeanXX.ListBeanX listBeanX : listBeanXX.getList()) {
                        ...
                        for (OilMapStoreListBeanV3.ListBeanXX.ListBeanX.ListBean listBean : listBeanX.getList()) {
...
//                            mAMap.moveCamera(CameraUpdateFactory.newLatLngZoom(latLngmarker, 11));
                                ...
                                public View getInfoWindow(final Marker marker) {
                                    ...
                                    navigation_iv.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            if (isGet) {
                                                Intent intent = new Intent(OilShortShareActivityV3.this, NaviMainActivity.class);
    ...
    public Drawable getDrawAble(int no, int num) {
        ...
        if (no == STORE_NO) {
            ...
            if (bitmapDrawable == null) {
                ...
                bitmapDrawable =
                        getApplication().getResources().getDrawable(
                                R.mipmap.red_defaultcluster_v3);
    ...
    public void getPermission() {
        ...
        if (Build.VERSION.SDK_INT >= 23 && !sdCardWritePermission) {
            PermissionGen.with(OilShortShareActivityV3.this)
                    .addRequestCode(100)
                    .permissions(
...
//       将属性设置给窗体
    ...
    private void showSelectStoreDialog(final String storeName) {
        dialog = new Dialog(this, R.style.ActionSheetDialogStyle);
        View view = LayoutInflater.from(this).inflate(R.layout.red_select_store_dialog_layout, null);
        ...
        select_g_store_re.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(OilShortShareActivityV3.this, SelectGStoreActivityV3.class);
                ...
                intent.putExtra("from", "oil_short_map");
        ...
        fetch_store_detail_re.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(OilShortShareActivityV3.this, StoreDetailActivityV3.class);
        ...
        same_store_re.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                is_check = true;
                check_iv.setBackgroundResource(R.mipmap.red_checked_v3);
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(g_store_name)) {
                    ...
                    if (SharedData.getInstance().isLogin()) {
                        dialog.dismiss();
                        Intent intent = new Intent(OilShortShareActivityV3.this, OilShareAppointActivityV3.class);
                        ...
                        startActivityForResult(new Intent(OilShortShareActivityV3.this, LoginActivity.class), LOGIN_REQUEST);
                    }
                }
            }
        });
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.user_car_guide_re:
                openWebView("http://106.14.135.110/SxcH5/polo.html", "燃油车辆指引", true);
                break;
            case R.id.faq_re:
                openWebView("http://106.14.135.110/SxcH5/fuel_problem.html", "常见问题", true);
                break;
            ...
            case R.id.problem_feedback_re:
                if (SharedData.getInstance().isLogin()) {
                    Intent intent1 = new Intent(OilShortShareActivityV3.this, ProblemFeedbackActivity.class);
                    intent1.putExtra("from", "oil");
                    startActivity(intent1);
                } else {
                    Intent intent_register = new Intent(OilShortShareActivityV3.this, LoginActivity.class);

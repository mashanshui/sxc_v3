...
public class LuxuryShareActivityV3 extends BaseActivity implements MapLoiIml,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setTopBarTitle("豪车租", null);
        setStatusView(R.color.luxury);
        setTopBarColor(R.color.luxury);
        StatusBarUtil.StatusBarDarkMode(this);
        setTopbarLeftWhiteBackBtn();
        zoom_out_iv.setBackgroundResource(R.mipmap.map_zoom_out_luxury_v3);
        zoom_in_iv.setBackgroundResource(R.mipmap.map_zoom_in_luxury_v3);
        lopoi_iv.setBackgroundResource(R.mipmap.lopoi_pic_luxury_v3);
        service_iv.setBackgroundResource(R.mipmap.luxury_service_center_v3);
    ...
    private void mapDot() {
        ...
        Observable<CodeResultV3<LuxuryMapStoreListBeanV3>> ob = service.getLuxuryMapStoreListV3();
        ob.compose(compose(this.<CodeResultV3<LuxuryMapStoreListBeanV3>>bindToLifecycle())).subscribe(new CodeObserverV3<LuxuryMapStoreListBeanV3>(this) {
            @Override
            protected void onHandleSuccess(LuxuryMapStoreListBeanV3 listBeanV3) {
                removeProgressDlg();
                for (LuxuryMapStoreListBeanV3.ListBeanXX listBeanXX : listBeanV3.getList()) {
...
//                            mAMap.moveCamera(CameraUpdateFactory.newLatLngZoom(latLngmarker, 11));
                                ...
                                public View getInfoWindow(final Marker marker) {
                                    ...
                                    navigation_iv.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            if (isGet) {
                                                Intent intent = new Intent(LuxuryShareActivityV3.this, NaviMainActivity.class);
    ...
    private BitmapDescriptor getBitmapDes(int num, int no, String city_name) {
        ...
        textView.setBackgroundDrawable(getDrawAble(no));
    ...
    public Drawable getDrawAble(int no) {
        if (no == STORE_NO) {
            Drawable bitmapDrawable = mBackDrawAbles.get(1);
            if (bitmapDrawable == null) {
                bitmapDrawable =
                        getApplication().getResources().getDrawable(
                                R.mipmap.luxury_circle_sloid_v3);
            ...
            if (bitmapDrawable == null) {
                ...
                bitmapDrawable =
                        getApplication().getResources().getDrawable(
                                R.mipmap.luxury_defaultcluster_v3);
    ...
    public void getPermission() {
        ...
        if (Build.VERSION.SDK_INT >= 23 && !sdCardWritePermission) {
            PermissionGen.with(LuxuryShareActivityV3.this)
                    .addRequestCode(100)
                    .permissions(
...
//       将属性设置给窗体
    ...
    private void showSelectStoreDialog(final String storeName) {
        dialog = new Dialog(this, R.style.ActionSheetDialogStyle);
        View view = LayoutInflater.from(this).inflate(R.layout.luxury_select_store_dialog_layout, null);
        ...
        fetch_store_detail_re.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(LuxuryShareActivityV3.this, StoreDetailActivityV3.class);
        ...
        g_store_name_tv.setText(fetch_store_name);
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(g_store_name)) {
                    ...
                    if (SharedData.getInstance().isLogin()) {
                        dialog.dismiss();
                        Intent intent = new Intent(LuxuryShareActivityV3.this, LuxuryCarListActivityV3.class);
                        ...
                        startActivityForResult(new Intent(LuxuryShareActivityV3.this, LoginActivity.class), LOGIN_REQUEST);
                    }
                }
            }
        });
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.user_car_guide_re:
                openWebView("http://106.14.135.110/SxcH5/carGuide/index.html", "车辆指引", true);
                break;
            case R.id.faq_re:
                openWebView("http://106.14.135.110/SxcH5/luxury_problem.html", "常见问题", true);
                break;
            ...
            case R.id.problem_feedback_re:
                if (SharedData.getInstance().isLogin()) {
                    Intent intent1 = new Intent(LuxuryShareActivityV3.this, ProblemFeedbackActivity.class);
                    intent1.putExtra("from", "luxury");
                    startActivity(intent1);
                } else {
                    Intent intent_register = new Intent(LuxuryShareActivityV3.this, LoginActivity.class);

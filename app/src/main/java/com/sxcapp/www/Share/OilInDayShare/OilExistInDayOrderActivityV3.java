...
public class OilExistInDayOrderActivityV3 extends BaseActivity implements MapLoiIml {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oil_inday_exist_v3);
        ...
        int width = AndroidTool.getDeviceWidth(OilExistInDayOrderActivityV3.this) - AndroidTool.dip2px(OilExistInDayOrderActivityV3.this, 74);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(width, width / 2);
        layoutParams.addRule(RelativeLayout.CENTER_HORIZONTAL);
        layoutParams.setMargins(0, AndroidTool.dip2px(OilExistInDayOrderActivityV3.this, 27), 0, 0);
    ...
    private void loadData() {
        ...
        ob.compose(compose(this.<CodeResultV3<OilInDayEndInfoBeanV3>>bindToLifecycle())).subscribe(new CodeObserverV3<OilInDayEndInfoBeanV3>(this) {
            ...
            protected void onHandleSuccess(final OilInDayEndInfoBeanV3 beanV3) {
                removeProgressDlg();
                Glide.with(OilExistInDayOrderActivityV3.this).load(beanV3.getCar_image()).into(car_iv);
                ...
                for (int i = 0; i < beanV3.getSettings().size(); i++) {
                    TextView rule_tv = new TextView(OilExistInDayOrderActivityV3.this);
                    ...
                    rule_tv.setPadding(AndroidTool.dip2px(OilExistInDayOrderActivityV3.this, 12), AndroidTool.dip2px(OilExistInDayOrderActivityV3.this, 12), 0, 0);
                ...
                appoint_btn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (AndroidTool.isGetLocationPermission(OilExistInDayOrderActivityV3.this)) {
                            if (lat != 0) {
                                showProgressDlg();
                ...
                fetch_store_re.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(OilExistInDayOrderActivityV3.this, StoreDetailActivityV3.class);
    ...
    private void unLockCar() {
        ...
        ob.compose(compose(this.<CodeResultV3<UnLockCarIsPhoto>>bindToLifecycle())).subscribe(new CodeObserverV3<UnLockCarIsPhoto>(this) {
            ...
            protected void onHandleSuccess(UnLockCarIsPhoto isPhoto) {
                ...
                removeProgressDlg();
                Intent intent = new Intent(OilExistInDayOrderActivityV3.this, OilInDayEndActivityV3.class);
            ...
            protected void onHandleError(String msg, CodeResultV3<UnLockCarIsPhoto> value) {
                ...
                if ("994".equals(value.getCode())) {
                    if (value.getObj().getImage_flag() == 0) {
                        Intent intent = new Intent(OilExistInDayOrderActivityV3.this, UploadCarInfoActivityV3.class);
                        intent.putExtra("order_no", order_no);

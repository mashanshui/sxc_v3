...
public class ElecInDayEndInfoBeanV3 {

    /**
     * order_no : 18042519437928
     ...
     * order_time : 2018-04-25T11:43:01.000+0000
     ...
     * life_km : 0
     * settings : ["提前还车，不存在费用返还","超过租赁天数按0.15元/分计费","还车时电量低于15%，扣款25.00元","还车时电量低于10%，扣款50.00元","各优惠不累计，最终解释权归本平台所有"]
     * single_cost : 90
     * coupon :
    ...
    private String fetch_longitude;
    private String fetch_latitude;
    ...
    public String getFetch_longitude() {
        return fetch_longitude;
    }

    public void setFetch_longitude(String fetch_longitude) {
        this.fetch_longitude = fetch_longitude;
    }

    public String getFetch_latitude() {
        return fetch_latitude;
    }

    public void setFetch_latitude(String fetch_latitude) {

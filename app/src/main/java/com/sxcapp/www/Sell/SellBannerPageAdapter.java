...
public class SellBannerPageAdapter extends PagerAdapter {
    private Context context;
    private List<BannerBean> list;

    public SellBannerPageAdapter(Context context, List<BannerBean> list) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        View view = LayoutInflater.from(context).inflate(R.layout.sell_banner_item, null);
